...
<head>
    ...
    <script>
        function getinfo() {
            if (grade_sendit() && id_sendit() && pw_sendit() && joinCheck()) {
                return true;
            }
            else {
                return false;
                    ...
                    <form action="../php/regist_proc.php" method="post" class="form" id="regist_form" name="regist_form"
                        ...
                        <div class="input-container">
                            <input class="input-box" type="text" maxlength="4" required placeholder=" " id="user_grade"
                                name="user_grade">
                            <label for="grade" class="signin-label">학번</label>
                        </div>
                        <div class="input-container">
                            <input class="input-box" type="text" required placeholder=" " id="user_name" name="user_name">
